...
insert into Expenses (id, comment, create_date, amount, currency, payer_id, split_type) values (1, 'Some comment', '2023-02-02', '169.36', 'EUR', 1, 0);
...
insert into ExpensesInfo (id, groupvar_id, friend_id, person_id, amount, paid, currency)
values (1, 1, 1, 1, 10, TRUE, 'EUR');